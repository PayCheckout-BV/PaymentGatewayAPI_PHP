	...
	class CurlRequest
	{
		...
		public function __construct($url)
		{
			...
			if ($this->curlSession !== false)
			{
				...
				// Use tls v1.2Enable all supported encodings?
				curl_setopt($this->curlSession,CURLOPT_SSLVERSION, CURL_SSLVERSION_TLSv1_2);
		...
		public function getResponse()
		{
			...
			$response = new CurlResponse($this->curlSession, curl_exec($this->curlSession));
